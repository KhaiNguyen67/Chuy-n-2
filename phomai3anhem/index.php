...
// ============================================================
// File: index.php
// Chức năng: Trang chủ hoàn chỉnh tích hợp Banner 50vh chống lỗi hiển thị,
//            3 Sản phẩm bán chạy nhất, 3 Bài viết mới nhất & Câu chuyện Glassmorphism.
// ============================================================
...
// 2. Lấy ra tối đa 3 bài viết blog mới nhất từ Database
try {
    $stmt_blog = $pdo->query("SELECT * FROM blogs ORDER BY id DESC LIMIT 3");
    $latest_blogs = $stmt_blog->fetchAll();
} catch (PDOException $e) {
    // Mảng rỗng dự phòng nếu bạn chưa tạo bảng hoặc cấu trúc dữ liệu blog
    $latest_blogs = []; 
}

// 3. Đường dẫn xử lý ảnh nền Banner nội bộ trên máy của bạn
...
<section class="position-relative d-flex align-items-center overflow-hidden" 
    ...
    <div class="container position-relative text-white right" style="z-index: 2;" data-aos="fade-right">
        <div class="row">
            <div class="col-md-8 col-lg-6">
                ...
                <p class="lead mb-4 text-white-100 "; font-weight: 400; max-width: 95%;">
...
<section class="container my-5 py-4">
    ...
    <div class="row g-4 justify-content-center">
        ...
        <?php else: ?>
            <div class="col-md-4 col-sm-6" data-aos="fade-up">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                    <div class="text-center p-3 bg-light" style="height: 220px;"><img src="https://images.unsplash.com/photo-1528750994863-30f4a7c05267?q=80&w=400" class="img-fluid h-100 style-contain"></div>
                    <div class="card-body p-4">
                        <span class="text-warning text-uppercase small fw-bold">Phô mai cứng</span>
                        <h5 class="fw-bold my-1"><a href="product.php" class="text-decoration-none text-dark hover-gold">Parmesan Thượng Hạng</a></h5>
                        <p class="text-muted small text-truncate-2">Ủ chín tự nhiên trên 24 tháng, đậm vị truyền thống vùng Emilia-Romagna Ý.</p>
                        <div class="d-flex align-items-center justify-content-between pt-2 border-top mt-2"><span class="fw-bold text-danger">185.000 đ</span><button class="btn btn-sm btn-gold rounded-circle p-2"><i class="bi bi-cart-plus fs-5"></i></button></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6" data-aos="fade-up">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                    <div class="text-center p-3 bg-light" style="height: 220px;"><img src="https://images.unsplash.com/photo-1596450514735-111a2fe02935?q=80&w=400" class="img-fluid h-100 style-contain"></div>
                    <div class="card-body p-4">
                        <span class="text-warning text-uppercase small fw-bold">Phô mai sợi</span>
                        <h5 class="fw-bold my-1"><a href="product.php" class="text-decoration-none text-dark hover-gold">Mozzarella Khối Dẻo</a></h5>
                        <p class="text-muted small text-truncate-2">Độ kéo sợi hoàn hảo, béo ngậy lý tưởng cho các món Pizza, nướng đút lò bơ tỏi.</p>
                        <div class="d-flex align-items-center justify-content-between pt-2 border-top mt-2"><span class="fw-bold text-danger">135.000 đ</span><button class="btn btn-sm btn-gold rounded-circle p-2"><i class="bi bi-cart-plus fs-5"></i></button></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6" data-aos="fade-up">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                    <div class="text-center p-3 bg-light" style="height: 220px;"><img src="https://images.unsplash.com/photo-1624806992066-50efd0f175a1?q=80&w=400" class="img-fluid h-100 style-contain"></div>
                    <div class="card-body p-4">
                        <span class="text-warning text-uppercase small fw-bold">Phô mai xanh</span>
                        <h5 class="fw-bold my-1"><a href="product.php" class="text-decoration-none text-dark hover-gold">Stilton Blue Cheese</a></h5>
                        <p class="text-muted small text-truncate-2">Hương nồng đặc trưng, kết cấu vân xanh mềm xốp cực hợp dùng kèm rượu vang đỏ.</p>
                        <div class="d-flex align-items-center justify-content-between pt-2 border-top mt-2"><span class="fw-bold text-danger">245.000 đ</span><button class="btn btn-sm btn-gold rounded-circle p-2"><i class="bi bi-cart-plus fs-5"></i></button></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
    ...
    <div class="container my-4">
        ...
        <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-4" data-aos="fade-up">
                        <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                            <div style="height: 200px; overflow:hidden;">
                                <img src="<?php echo !empty($blog['image']) ? 'assets/img/'.$blog['image'] : 'https://images.unsplash.com/photo-1532634922-8fe0b757fb13?q=80&w=500'; ?>" class="w-100 h-100" style="object-fit: cover;" alt="Blog Image">
                            </div>
                            <div class="card-body p-4">
                                <small class="text-muted d-block mb-2"><i class="bi bi-calendar3 me-2"></i><?php echo date('d/m/Y', strtotime($blog['created_at'] ?? 'now')); ?></small>
                                <h5 class="fw-bold text-dark mb-2 text-truncate-2">
                                    <a href="chitiethuongdan.php?id=<?php echo $blog['id']; ?>" class="text-decoration-none text-dark hover-gold">
            ...
            <?php else: ?>
                <div class="col-md-4" data-aos="fade-up">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                        <img src="https://images.unsplash.com/photo-1532634922-8fe0b757fb13?q=80&w=500" class="card-img-top" style="height: 180px; object-fit: cover;" alt="Blog 1">
                        <div class="card-body p-4">
                            <small class="text-muted d-block mb-2"><i class="bi bi-calendar3 me-2"></i>27/05/2026</small>
                            <h5 class="fw-bold text-dark mb-2">Bí Quyết Kết Hợp Phô Mai Xanh Và Rượu Vang</h5>
                            <p class="text-muted small">Khám phá cách hòa quyện vị béo ngậy, đậm đà của Stilton Blue Cheese cùng các dòng vang đỏ cao cấp chuẩn châu Âu.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                        <img src="https://images.unsplash.com/photo-1452195100486-9cc805987862?q=80&w=500" class="card-img-top" style="height: 180px; object-fit: cover;" alt="Blog 2">
                        <div class="card-body p-4">
                            <small class="text-muted d-block mb-2"><i class="bi bi-calendar3 me-2"></i>15/05/2026</small>
                            <h5 class="fw-bold text-dark mb-2">Phân Biệt Các Loại Phô Mai Phổ Biến Nhất</h5>
                            <p class="text-muted small">Cẩm nang toàn diện phân biệt Cheddar, Mozzarella, Parmesan và Blue Cheese dành cho người mới bắt đầu.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white product-card-hover">
                        <img src="https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b?q=80&w=500" class="card-img-top" style="height: 180px; object-fit: cover;" alt="Blog 3">
                        <div class="card-body p-4">
                            <small class="text-muted d-block mb-2"><i class="bi bi-calendar3 me-2"></i>02/05/2026</small>
                            <h5 class="fw-bold text-dark mb-2">Học Làm Bánh Cheese Cake Chuẩn Vị Pháp</h5>
                            <p class="text-muted small">Hướng dẫn từng bước tự làm bánh kem phô mai béo mịn, ngọt dịu tan ngay đầu lưỡi ngay tại căn bếp nhỏ của bạn.</p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<style>
/* Style phụ trợ định vị và xử lý độ dài chuỗi */
.text-truncate-2 {
    display: -webkit-box;
    -webkit-line-clamp: 2;
