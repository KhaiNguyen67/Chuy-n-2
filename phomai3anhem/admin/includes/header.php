...
<div class="sidebar d-flex flex-column pt-3">
    ...
    <ul class="nav flex-column flex-grow-1">
        ...
        <li class="nav-item"><a href="products.php" class="nav-link"><i class="bi bi-box-seam"></i> Quản lý Sản phẩm</a></li>
        <li class="nav-item"><a href="categories.php" class="nav-link"><i class="bi bi-tags"></i> Quản lý Danh mục</a></li>
        <li class="nav-item"><a href="orders.php" class="nav-link"><i class="bi bi-receipt"></i> Quản lý Đơn hàng</a></li>
        <li class="nav-item"><a href="users.php" class="nav-link"><i class="bi bi-people"></i> Quản lý Người dùng</a></li>
        <li class="nav-item"><a href="blogs.php" class="nav-link"><i class="bi bi-journal-text"></i> Quản lý Bài viết</a></li>
    </ul>
