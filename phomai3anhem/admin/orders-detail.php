...
// Chức năng: Xem thông tin chi tiết hóa đơn (Đồng bộ CSDL mới)
// ============================================================
    ...
    <div class="row g-4">
        <div class="col-md-5">
            ...
            <div class="card admin-card bg-white border-0 shadow-sm rounded-4 p-4">
                ...
                <button class="btn btn-dark w-100 btn-sm py-2.5 rounded-pill fw-bold" onclick="window.print()"><i class="bi bi-printer me-2"></i> In phiếu giao hàng (Hóa đơn)</button>
            </div>
        </div>
