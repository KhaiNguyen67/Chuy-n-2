...
// Truy vấn gom nhóm tổng số lượng từ bảng order_details, liên kết bảng products để lấy thông tin hiển thị
...
// Tạo một mảng lưu trữ danh sách ID của top 3 sản phẩm bán chạy để đối chiếu nhanh phía dưới
                        ...
                        <?php foreach ($products as $prod): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if (in_array($prod['id'], $top3_ids)): ?>
                                        <span class="badge bg-danger text-white rounded-pill px-2.5 py-1 small fw-bold shadow-sm animate-pulse"><i class="bi bi-fire me-1"></i>Bán chạy nhất</span>
...
/* Hiệu ứng nhấp nháy thu hút sự chú ý cho Badge bán chạy */
@keyframes pulse {
    0% { opacity: 0.85; }
